...
Then("I select an option as {string}") do
  on(CompleteForm).select_college
end

Then("I select a checkbox as {string}") do
  on(CompleteForm).check_gender
end

Then("I select years of experience as {string}") do
  on(CompleteForm).select_exp
end

Then("I select date as {string}") do
...
Then("I see success message as {string}") do
